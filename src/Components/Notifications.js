			...
			<div class="row d-flex">
				...
				<div class="col-12 col-lg-9 px-0">
							...
							<nav class="navbar navbar-expand-lg inner text-center text-md-left">
								<div id="navbarText" class="mx-auto mx-md-0">
									...
									<li class="nav-item">
										...
										<li class="nav-item">
                                            <Link  class="nav-link active" Link to={'/Notifications'}>Notifications</Link>
										</li>
									</ul>
								</div>
							</nav>
					...
					<div class="container-fluid px-3 py-3 px-md-5 py-md-5">
						<h1 class="inner">Notifications</h1>
						<div class="light-gray-bg px-3 py-3 px-md-5 py-md-5">
							<p>
								Notify me about news and offers by
							</p>
							<div class="row">
								<form class="inner-form col-12">
