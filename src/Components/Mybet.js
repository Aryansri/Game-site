...
export default class Mybet extends Component {
    constructor(props) {
        super(props);
        this.state = {
          open: false,
					...
					<nav class="navbar navbar-expand-lg">
						...
						<div class="navbar-collapse offcanvas-collapse" id="collapsingNavbar1">
							<ul class="nav flex-column text-left side-menu">
								<li class="nav-item">
									<a href="#" class="nav-link dropdown-toggle" data-taggle="collapse"  onClick={function(){this.setState({open:!this.state.open})}.bind(this)}><span class="profile"></span>Edit Profile</a>
