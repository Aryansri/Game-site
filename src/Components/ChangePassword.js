...
<div class="container-fluid">
			<div class="row d-flex">
					...
					<nav class="navbar navbar-expand-lg">
						...
						<div class="navbar-collapse offcanvas-collapse" id="collapsingNavbar1">
							<ul class="nav flex-column text-left side-menu">
                                ...
                                <Link class="nav-link"Link to={'/Mybet'}><span  class="bonuses"></span>Mybets</Link>
				...
				<div class="col-12 col-lg-9 px-0">
						...
						<div class="container-fluid px-3 py-3">
							<nav class="navbar navbar-expand-lg inner text-center text-md-left">
								<div id="navbarText" class="mx-auto mx-md-0">
                                    ...
                                    <li class="nav-item">		
                                        <Link  class="nav-link active " Link to={'/ChangePassword'}>Change Password</Link>
                                    </li>
                                    <li class="nav-item">
					...
					<div class="container px-3 py-3 px-md-5 py-md-5">
						<h1 class="inner">Change Password</h1>
						<div class="light-gray-bg px-5 py-5">
							<form class="inner-form">
								...
								<hr class="my-5"/>
								<button class="btn btn-light" type="submit">Save Password</button>
							</form>
						</div>
					</div>	
				</div>
